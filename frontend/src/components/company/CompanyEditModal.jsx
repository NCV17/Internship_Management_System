...
const CompanyEditModal = ({ company, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || "Cập nhật công ty thất bại.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="modal-box" style={{ maxWidth: "600px" }} onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-title-group">
            ...
            <div>
              <h2 className="modal-title">Chỉnh sửa thông tin công ty</h2>
              <p className="modal-subtitle">Cập nhật hồ sơ đối tác {company.CompanyName}</p>
            </div>
          </div>
